...
powershell -Command "& {Invoke-WebRequest -URI https://github.com/Graylog2/collector-sidecar/releases/download/1.5.0/graylog_sidecar_installer_1.5.0-1.exe -OutFile graylog_sidecar_installer.exe}"

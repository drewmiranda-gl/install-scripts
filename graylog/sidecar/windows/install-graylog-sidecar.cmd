...
powershell -Command "& {$ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -URI https://github.com/Graylog2/collector-sidecar/releases/download/1.5.6/graylog_sidecar_installer_1.5.6-1.exe -OutFile graylog_sidecar_installer.exe}"

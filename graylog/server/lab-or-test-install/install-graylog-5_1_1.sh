...
sudo apt-get update --allow-releaseinfo-change && sudo apt-get -y install lsb-release ca-certificates curl gnupg2
...
sudo apt update --allow-releaseinfo-change && sudo apt install -y graylog-enterprise=5.1.1-1

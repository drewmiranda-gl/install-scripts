...
sudo apt update --allow-releaseinfo-change && sudo apt install -y lsb-release ca-certificates curl gnupg2
...
sudo OPENSEARCH_INITIAL_ADMIN_PASSWORD=$(tr -dc A-Z-a-z-0-9_@#%^-_=+ < /dev/urandom  | head -c${1:-32}) apt install -y opensearch
